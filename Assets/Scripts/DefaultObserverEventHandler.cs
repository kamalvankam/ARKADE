...
/// When implementing custom event handler behavior, consider inheriting from this class instead.- Mine
/// </summary>
public class DefaultObserverEventHandler : MonoBehaviour
{
    public GameObject apple,burger,bike,tvaddiction;
    ...
    protected virtual void OnTrackingFound()
    {
        if (mObserverBehaviour)
        {
            ...
            foreach (var component in canvasComponents)
                ...
                if(mObserverBehaviour.TargetName == "AppleMarkerJPEG")
                {
                    apple.SetActive(true);

                }
                if(mObserverBehaviour.TargetName == "ChikenBurgerJPEG")
                {
                    burger.SetActive(true);
                }
                if(mObserverBehaviour.TargetName == "BIkeImageJPEG")
                {
                    bike.SetActive(true);
                }
                if(mObserverBehaviour.TargetName=="AddictionJPEG")
                {
                    tvaddiction.SetActive(true);
                }
